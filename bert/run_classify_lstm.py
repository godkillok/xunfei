...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    GlobalMaxPooling1D=tf.layers.max_pooling1d (output_rnn, ksize=[1, FLAGS.max_seq_length, 1],
                   strides=[1, 1, 1], padding="VALID", name="GlobalMaxPooling1D")# [batch_size,hidden_size*2]

    GlobalAveragePooling1D = tf.layers.average_pooling1d(output_rnn, ksize=[1, FLAGS.max_seq_length,  1],
