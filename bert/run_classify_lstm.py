...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    GlobalMaxPooling1D=tf.nn.max_pool(output_rnn, ksize=[1, FLAGS.max_seq_length, 1, 1],
                   strides=[1, 1, 1, 1], padding="VALID", name="GlobalMaxPooling1D")# [batch_size,hidden_size*2]

    GlobalAveragePooling1D = tf.nn.avg_pool(output_rnn, ksize=[1, FLAGS.max_seq_length, 1, 1],
                                        strides=[1, 1, 1, 1], padding="VALID", name="GlobalAveragePooling1D")
